...
2.  Cards cant be clicked unless you exit CEF screen and relaunch fileshare CEF screen(fixed on upcomming Redesign by Warm Beer)
3.  Pressing enter on search sometimes shows duplicate results(fixed on upcomming Redesign by Warm Beer)
