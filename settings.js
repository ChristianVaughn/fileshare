...
dew.on('show', function(e){
	dew.notify("server_settingsShow"); // Broadcast dew.show so other screens can detect this
    $('#settingsWindow').hide();
    $('#blackLayer').hide();
...
dew.on('hide', function(e){
	dew.notify("server_settingsHide"); // Broadcast dew.hide so other screens can detect this
    if(repGP){
        window.clearInterval(repGP);
        repGP = null;
    }
